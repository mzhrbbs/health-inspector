...
class ListItem extends React.Component {
    ...
    render() {
        ...
        const containerClasses = this.state.showMore ? 'result-list-item-container result-list-item-container-large'  : 'result-list-item-container'
                ...
                <div className={containerClasses}>
                    <div className="result-list-item">
                        <div className="result-list-item-description">
                                ...
                                <p className="result-list-item-last-updated"> Last Updated on {date.format('MMM D YYYY')}></p>
